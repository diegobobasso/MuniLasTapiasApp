-- 🏛️ Inicialización institucional de la base de datos municipal
-- Estructura completa + superadmin por defecto
...
-- 🔐 Inserta superadmin institucional con contraseña temporal
-- ⚠️ Reemplazá el hash por uno generado con bcrypt.hashSync('admin123', 12)
INSERT INTO empleados (
  nombre, email, dni, username, password_hash, rol, activo, requiere_cambio_password
) VALUES (
  'Superadministrador',
  'admin@municipalidad.gob.ar',
  '00000000',
  'admin',
  '$2b$12$XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX', -- ← reemplazar con hash real
  'admin',
  TRUE,
  TRUE
);
